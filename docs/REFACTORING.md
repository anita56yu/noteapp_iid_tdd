...
-   Create a new task in `docs/FEATURES.md` for this refactoring effort.
...
## 4. Execute Using TDD
-   For each incremental change identified in the plan, follow the complete TDD loop as described in **`docs/TDD.md`**. This includes:
...
## 5. Commit
-   Once all incremental changes are complete and all tests are passing, follow the **Commit** step in **`docs/TDD.md`**. This includes marking the task as complete and committing the changes with a `refactor` type commit message.
